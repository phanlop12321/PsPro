        ...
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              <h3>แต่งตั้งคณะกรรมการราคากลาง</h3>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-12 col-12">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form form-horizontal" action="adddirector.php" method="POST">
                      <div class="form-body">
                        <div class="row">
                          <div class="row">
                            <div class="col-md-3">
                              <label>อนุมัติกำหนดราคากลาง</label>
                            </div>
                            <div class="col-md-3 form-group">
                              <input type="text" class="form-control" name="center_price" value="<?php if (isset($row3["Center_Price"])) {
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" onkeyup="serchcheck('FName_Chairman_Center_Price')"
                                class="form-control" name="FName_Chairman_Center_Price" placeholder="" value="<?php if (isset($row3["FName_Chairman_Center_Price"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="Lname_Chairman_Center_Price" placeholder=""
                                value="<?php if (isset($row3["Lname_Chairman_Center_Price"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="Rank_C_C" value="<?php if (isset($row3["Rank_C_C"])) {
                                echo $row3["Rank_C_C"];
                              } ?>" required>
                            </div>
                            <div class="col-md-3 ">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" onkeyup="serchcheck('FName_Director_1')" class="form-control"
                                name="FName_Director_1" placeholder="" value="<?php if (isset($row3["FName_Director_1"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="LName_Director_1" value="<?php if (isset($row3["LName_Director_1"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="Rank_D_C1" value="<?php if (isset($row3["Rank_D_C1"])) {
                                echo $row3["Rank_D_C1"];
                              } ?>" required>
                            </div>
                            <div class="col-md-3 ">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" onkeyup="serchcheck('FName_Director_2')" class="form-control"
                                name="FName_Director_2" placeholder="" value="<?php if (isset($row3["FName_Director_2"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="LName_Director_2" value="<?php if (isset($row3["LName_Director_2"])) {
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="Rank_D_C2" value="<?php if (isset($row3["Rank_D_C2"])) {
                                echo $row3["Rank_D_C2"];
                              } ?>" required>
                            </div>
                            <div class="col-md-3 ">
