                                                ...
                                                if ($row12["price"] != 0) {
                                                    ...
                                                    <tr style="font-size: 14px;">
                                                        ...
                                                        <td style="width: 8rem;text-align:center;">
                                                            <input
                                                                id="case_ID<?= $DataIdForAt ?><?= $DataIdForType ?><?= $DataQTYForSelect ?>"
                                                                onclick=" checkdata(<?= $DataIdForAt ?>,'<?= $DataIdForType ?>','<?= $DataQTYForSelect ?>')"
                                                                type="text" class="form-control" name="case"
                                                                value="<?= $row12["AT"]; ?>" autocomplete="off" required>
                                                            <span
                                                                id="case<?= $DataIdForAt ?><?= $DataIdForType ?><?= $DataQTYForSelect ?>"
                                                                class="search_result<?= $DataIdForAt ?><?= $DataIdForType ?><?= $DataQTYForSelect ?>">
    ...
    <script>
        ...
        const fetchdata285case = (data285Name) => {
            fetch("service/getcase285.php", {
                ...
                if (html != null) {
                    document.getElementById('case' + DataNumberId + DataNumbForType + DataNumbForQty).innerHTML = html;
                }
            });
        };
        ...
        function selectdata285case(key) {
            ...
            let y = 0;
            document.getElementById('case_ID' + DataNumberId + DataNumbForType + DataNumbForQty).value = Data285Selected.AT_NAME
            ...
            const els = document.getElementsByClassName('search_result' + DataNumberId + DataNumbForType + DataNumbForQty);
