...
if ($_SESSION["Depratment"] == 02) { //check session
    ...
    Header("Location: form-pricen2.php"); //ไม่พบผู้ใช้กระโดดกลับไปหน้า login form 
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($row["price"] != 0) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?= "";
                                                                        echo number_format($row["price"] * ($row["wage"] / 100) * $row["factor"] / $row["qty"], 2); ?>
                                                                    </td>
                                                                    <td>
                                                                        <?= "";
                                                                        echo number_format($row["price"] * ($row["wage"] / 100) * $row["factor"], 2); ?>
                                                                    </td>
                                                                    <td>
                                                                        <input type='text' class="form-control"
