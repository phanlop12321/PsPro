            ...
            <div class="col-md-12 col-12">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form form-horizontal" action="addContract.php" method="POST">
                      <div class="form-body">
                        <div class="row">
                          <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2 form-group">
                              <input type="text" class="form-control" name="ContractNo" value="<?php if (isset($rowcon["ContractNo"])) {
                                echo $rowcon["ContractNo"];
                              } ?>" required>
                            </div>
                            <div class="col-md-1">
                            </div>
                            ...
                            <div class="col-md-2 form-group">
                              <input type="date" class="form-control" name="ContractDate" value="<?php if (isset($rowcon["ContractDate"])) {
                                echo $rowcon["ContractDate"];
                              } ?>" required>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-md-1 form-group">
                              <input type="text" class="form-control" name="ContractQTY" value="<?php if (isset($rowcon["ContractQTY"])) {
                                echo $rowcon["ContractQTY"];
                              } ?>" required>
                            </div>
                            <div class="col-md-1">
                            </div>
                            <div class="col-md-2 d-flex justify-content-end">
                              <label>เงินค้ำประกันผลงาน(บาท)</label>
                            </div>
                            <div class="col-md-1 form-group">
                              <input type="text" class="form-control" name="ContractMoney" value="<?php if (isset($rowcon["ContractMoney"])) {
                                echo $rowcon["ContractMoney"];
                              } ?>" required>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-3">
                              <label>กำหนดเวลาแล้วเสร็จภายใน(วัน)</label>
                            </div>
                            <div class="col-md-1 form-group">
                              <input type="text" class="form-control" name="ContractFinish" value="<?php if (isset($rowcon["ContractFinish"])) {
                                echo $rowcon["ContractFinish"];
                              } ?>" required>
                            </div>
                            <div class="col-md-3 d-flex justify-content-end">
                              <label>ระยะเวลาในการดำเนินการไม่เกิน(วัน)</label>
                            </div>
                            <div class="col-md-1 form-group">
                              <input type="number" class="form-control" name="ContractBegin" value="<?php if (isset($rowcon["ContractBegin"])) {
                                echo $rowcon["ContractBegin"];
                              } ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <label>ชื่อการไฟฟ้า</label>
                            </div>
                            <div class="col-md-6 form-group">
                              <input type="text" class="form-control" name="NamePea" value="<?php if (isset($rowcon["NamePea"])) {
                                echo $rowcon["NamePea"];
                              } ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                              <input type="text" class="form-control" name="AddressPea" value="<?php if (isset($rowcon["AddressPea"])) {
                                echo $rowcon["AddressPea"];
                              } ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-3 mb-3">
                              <label>ผู้มีอำนาจลงนามในสัญญา</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-3 form-group">
                              <input type="text" onkeyup="serchcheck('ContractFname')" class="form-control"
                                name="ContractFname" placeholder="" value="<?php if (isset($rowcon["ContractFname"])) {
                                  echo $rowcon["ContractFname"];
                                } ?>" required>
                              <span id="search_result_CheckName7" class="search_Check">
                            </div>
                            <div class="col-md-1 d-flex justify-content-end">
                              <label>นามสกุล</label>
                            </div>
                            <div class="col-md-3 form-group">
                              <input type="text" class="form-control" name="ContractLname" value="<?php if (isset($rowcon["ContractLname"])) {
                                echo $rowcon["ContractLname"];
                              } ?>" required>
                            </div>
                            <div class="col-md-1 d-flex justify-content-end">
                              <label>ตำแหน่ง</label>
                            ...
                            <div class="col-md-3 form-group">
                              <input type="text" class="form-control" name="ContractUnder" value="<?php if (isset($rowcon["ContractUnder"])) {
                                echo $rowcon["ContractUnder"];
                              } ?>" required>
                            </div>
                          </div>
